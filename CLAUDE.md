...
Claude Code reading this: you are likely running inside `../<repo>-claude`
(see [scripts/setup-worktrees.sh](scripts/setup-worktrees.sh)), on the branch
assigned to you in [TASKS.md](TASKS.md). A second agent (e.g. an
OpenAI/Codex-based agent, see [AGENTS.md](AGENTS.md)) may be working in a
sibling worktree on a different branch at the same time. Stay inside your
assigned scope so your work merges cleanly.
...
- Use `scripts/launch-claude.sh` to enter your worktree and start a session.
